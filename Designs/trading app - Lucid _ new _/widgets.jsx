...
function Hero({ row, candles }) {
  ...
  return (
    <div className="hero">
      <div className="hero-cell" style={{ margin: "4px" }}>
        <div className="sym-row">
          <div className="sym">{row.sym}</div>
          <div className="name">{row.name} · NASDAQ</div>
        </div>
        <div className="mega mono" style={{ fontFamily: "\"Source Serif Pro\"", fontSize: "92px", fontWeight: "500", padding: "8px 0px 4px" }}>{fmt(last, 2)}</div>
