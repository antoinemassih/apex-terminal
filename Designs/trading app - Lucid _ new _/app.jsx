  ...
  return (
    <div className="shell">
      ...
      {route==='apex'  && <ApexLayout activeRow={activeRow} setActiveSym={setActiveSym} D={D} dotmatrix={tweaks.dotmatrix}
                                     showVol={tweaks.showVol} showMA={tweaks.showMA} showBB={tweaks.showBB}/>}
      {route==='apex-alt' && <ApexAltPage activeRow={activeRow} setActiveSym={setActiveSym} D={D} showVol={tweaks.showVol} showMA={tweaks.showMA} showBB={tweaks.showBB}/>}
      ...
      {route==='trade-alt' && <TradeAltPage activeRow={activeRow} setActiveSym={setActiveSym} D={D} showVol={tweaks.showVol} showMA={tweaks.showMA} showBB={tweaks.showBB}/>}
      ...
      <TweaksPanel>
        ...
        <TweakSection label="Layout">
          ...
          <TweakSelect label="View" value={route} options={[
            ...
            {label:'Apex Alt · Lucid',value:'apex-alt'},
            {label:'Chart · Analysis',value:'chart'},
            {label:'Trade · Floating',value:'trade'},
            {label:'Trade Alt · Lucid',value:'trade-alt'},
  ...
  return (
    <div className="topbar" data-screen-label="Top Bar">
      <div className="brand">
        ...
        <div>
          <div className="name">Lucid</div>
          <div className="sub">Trade · v4.2</div>
        </div>
      </div>
      <div className="nav">
        ...
        <div className={'nav-item '+(route==='trade-alt'?'on':'')} onClick={()=>setRoute('trade-alt')}>Trade Alt</div>
        <div className={'nav-item '+(route==='apex'?'on':'')} onClick={()=>setRoute('apex')}>Apex</div>
        <div className={'nav-item '+(route==='apex-alt'?'on':'')} onClick={()=>setRoute('apex-alt')}>Apex Alt</div>
      ...
      <div className="topright">
        ...
        <div className="session">
          ...
          <div className="row" style={{marginTop:4, color:'var(--muted)'}}>
            ...
            <span className="mono" style={{fontSize:11}}>j.morgan@lucid.co</span>
          </div>
        </div>
      </div>
    </div>
