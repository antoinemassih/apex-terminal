...
pub enum Size {
    ...
    Percent(f32),
    /// Size to content (egui measures it).
    Auto,
...
impl Item {
    ...
    fn new(size: Size) -> Self {
        Self { size, cross: None, min: None, align_self: None }
    }
...
impl Flex {
    ...
    pub fn padding(mut self, px: f32) -> Self {
        let p = px as i8;
        self.pad = egui::Margin { left: p, right: p, top: p, bottom: p };
        self
    }

    /// Non-uniform inner padding.
    pub fn padding_margin(mut self, m: egui::Margin) -> Self { self.pad = m; self }
    ...
    pub fn solve(&self, available: Vec2) -> Vec<Rect> {
        ...
        let root_style = Style {
            ...
            padding: taffy::geometry::Rect {
                left: length(self.pad.left as f32),
                right: length(self.pad.right as f32),
                top: length(self.pad.top as f32),
                bottom: length(self.pad.bottom as f32),
            },
