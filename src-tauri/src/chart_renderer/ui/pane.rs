...
impl Pane for PlaysPaneAdapter {
    fn render(&mut self, ui: &mut egui::Ui, _ctx: &egui::Context, cx: &mut PaneContext<'_>) {
        ...
        super::plays_panel::draw_content(
            ui,
            cx.watchlist,
            cx.panes,
            ap,
...
pub struct DomPaneAdapter<'d> {
    ...
    pub levels: &'d [super::dom_panel::DomLevel],
    pub tick_size: f32,
    ...
    pub dom_order_type: &'d mut super::dom_panel::DomOrderType,
