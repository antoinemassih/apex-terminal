...
impl SidePanel for IndicatorEditor {
    ...
    fn draw(&mut self, ctx: &egui::Context, cx: &mut PanelContext<'_>) {
        super::indicator_editor::draw(ctx, cx.watchlist, cx.panes, *cx.active_pane, cx.theme);
    }
}
...
impl SidePanel for HotkeyEditor {
    ...
    fn draw(&mut self, ctx: &egui::Context, cx: &mut PanelContext<'_>) {
        super::hotkey_editor::draw(ctx, cx.watchlist, cx.panes, *cx.active_pane, cx.theme);
    }
}
...
impl SidePanel for OptionQuickPicker {
    ...
    fn draw(&mut self, ctx: &egui::Context, cx: &mut PanelContext<'_>) {
        super::option_quick_picker::draw(ctx, cx.watchlist, cx.panes, *cx.active_pane, cx.theme);
    }
}
