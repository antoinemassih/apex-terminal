...
impl<'a> PanelHeader<'a> {
    pub fn new(title: &'a str) -> Self {
        Self {
            ...
            dim:    Color32::from_rgb(90, 90, 100),
        }
    }
...
impl<'a> Widget for PanelHeader<'a> {
    fn ui(self, ui: &mut Ui) -> Response {
        ...
        ui.horizontal(|ui| {
            ui.label(RichText::new(title_text).monospace().size(11.0).strong().color(accent));
        }).response
    }
}
        ...
        let frame_resp = egui::Frame::NONE
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    ui.label(RichText::new(title_text).monospace().size(font_lg()).strong().color(text_col));
                });
            });
