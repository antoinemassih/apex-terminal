    ...
    if chart.order_collapsed {
        ...
        egui::Window::new(format!("order_pill_{}", c.pane_idx))
            ...
            .frame(egui::Frame::popup(&c.ctx.style())
                .fill(color_alpha(c.t.toolbar_bg, 235))
            ...
            .show(c.ctx, |ui| {
                let resp = ui.horizontal(|ui| {
                    ...
                    ui.add_space(12.0);
                    ui.label(egui::RichText::new("ORDER").monospace().size(9.0).strong().color(c.t.dim.gamma_multiply(0.7)));
                });
    ...
    egui::Window::new(format!("order_entry_{}", c.pane_idx))
        ...
        .show(c.ctx, |ui| {
            ...
            let header_resp = ui.horizontal(|ui| {
                ...
                ui.label(egui::RichText::new("ORDER").monospace().size(9.0).strong().color(c.t.dim.gamma_multiply(0.6)));
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.label(egui::RichText::new(exp_icon).size(9.0).color(c.t.dim.gamma_multiply(0.5)));
