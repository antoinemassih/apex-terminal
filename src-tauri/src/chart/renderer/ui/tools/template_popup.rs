                ...
                ui.add_space(gap_sm());
                        ...
                        ui.horizontal(|ui| {
                            for (ptype, label, icon) in [
                                (super::super::super::gpu::PaneType::Chart, "Chart", Icon::CHART_LINE),
                                (super::super::super::gpu::PaneType::Portfolio, "Portfolio", Icon::LIST),
                                (super::super::super::gpu::PaneType::Dashboard, "Dashboard", "\u{2637}"),
                                (super::super::super::gpu::PaneType::Heatmap, "Heatmap", "\u{2593}"),
                            ...
                            if can_save {
                                if small_action_btn(ui, "Save", t.accent) {
                                    ...
                                    let indicators: Vec<serde_json::Value> = p.indicators.iter().map(|ind| serde_json::json!({
                                        ...
                                        "line_style": match ind.line_style { super::super::super::LineStyle::Solid => "solid", super::super::super::LineStyle::Dashed => "dashed", super::super::super::LineStyle::Dotted => "dotted" },
    ...
    if let Some(inds) = tmpl.get("indicators").and_then(|v| v.as_array()) {
        ...
        for (idx, ind_json) in inds.iter().enumerate() {
            ...
            ind.line_style = match ind_json.get("line_style").and_then(|v| v.as_str()).unwrap_or("solid") {
                "dashed" => super::super::super::LineStyle::Dashed, "dotted" => super::super::super::LineStyle::Dotted, _ => super::super::super::LineStyle::Solid,
            };
